 ...
 *
 * ใช้ทั้งเว็บ: หน้าแรก + ปุ่มกรอง /insights + กลุ่มใน /track-record (lib/segments.ts เรียกไฟล์นี้)
 * แยก "ชิป & ฮาร์ดแวร์" / "ซอฟต์แวร์ & คลาวด์" / "อินเทอร์เน็ต & สื่อ" ออกจากกัน — หุ้นเทคเกินครึ่ง รวมกลุ่มเดียวก็ยาวเกินจะไล่ดู
 *
